...
import com.bayram.controller.IStudentController;
...
@Override
public DtoStudent updateStudent(@PathVariable(name = "id") Integer id, @RequestBody DtoStudentIU dtoStudentU) {

	return studentService.updateStudent(id,dtoStudentU);
